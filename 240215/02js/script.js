...
//  사용자에게 숫자를 하나 전달받으세요
// 해당 숫자가 소수인지 식별후 소수라면 00숫자는 소수입니다 출력
...
// 사용자에게 1보다 큰 수를 하나 전달받으세요 그리고 그 숫자안에 있는 짝수들만 더해서 웹 브라우저 화면에 출력해주세요

// 1 1보다 큰 수 입력하게 하는 계산식 쓰기
// 2 1에서 짝수만 추출하는 계산식 쓰기
// 3 2에서 추출한 수를 모두 더하는 계산식 쓰기
// 4 출력하기
